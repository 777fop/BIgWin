        ...
        <CardContent className="space-y-6">
                      ...
                      <div className="text-center">
                        ...
                        <div className="grid grid-cols-3 gap-2 text-sm">
                          <div className="bg-blue-600/30 p-2 rounded">
                            ...
                            <div className="text-blue-300">{match.homeOdds || '2.1'}x</div>
                          </div>
                          <div className="bg-yellow-600/30 p-2 rounded">
                            <div className="font-bold">Draw</div>
                            <div className="text-yellow-300">{match.drawOdds || '3.2'}x</div>
                          </div>
                          <div className="bg-red-600/30 p-2 rounded">
                            <div className="font-bold">Away Win</div>
                            <div className="text-red-300">{match.awayOdds || '2.8'}x</div>
                          </div>
                        </div>
                      </div>
                    </CardContent>
          ...
          {selectedMatch && (
            <div className="bg-green-900/30 border border-green-500/30 p-6 rounded-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-2">Bet Option</label>
                  <select
                    value={betOption}
              ...
              <div className="grid grid-cols-4 gap-2 mt-4">
                {[1, 5, 10, 25].filter(amount => amount <= user.balance).map(amount => (
                  <Button
                    ...
                    className="bg-green-600/20 border border-green-500/30 text-green-300 hover:bg-green-600/30"
                    size="sm"
                  >
                    {amount}
                  </Button>
